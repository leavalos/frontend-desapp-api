<template>
  <div>
    ...
    <div style="padding: 10px 10px 10px 10px;">
        ...
        <center>
            <md-button class="md-simple" @click="donate(projectName)">{{ $t('landing.modal.donate') }}</md-button>
            <md-button
    ...
    <md-button class="md-success md-round classic-modal" @click="showDialog = true">{{ $t('landing.donate') }}</md-button>
  </div>
</template>
